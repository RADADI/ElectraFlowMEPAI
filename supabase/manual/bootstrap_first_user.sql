-- Run once in Supabase SQL Editor after PRODUCTION_BOOTSTRAP_FULL_SCHEMA.sql
-- (or migration-phase5.sql) if bootstrap_first_user() is not already present.
-- Source: src/database/migration-phase5b-bootstrap-first-user.sql
