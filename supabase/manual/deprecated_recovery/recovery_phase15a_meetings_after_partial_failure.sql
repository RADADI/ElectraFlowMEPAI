-- ===========================================================================
-- ElectraFlow AI — Recovery: Phase 15A Meetings (after partial failure)
-- ===========================================================================
-- Use when manual_run_007_015.sql failed at is_meeting_attendee() because
-- meeting tables did not exist yet (pre-fix migration ordering bug).
--
-- Safe to run on a database where migrations 001–011 completed and 012 failed
-- partway through. Does NOT drop unrelated tables. No seed data.
--
-- NEXT after this file succeeds:
--   Run migrations 013–015 from manual_run_007_015.sql (phase15b, 15c, 15d)
--   OR re-run only the 013/014/015 sections from that file.
-- ===========================================================================

-- ─── Prerequisite helpers (no-op if already created) ─────────────────────────
...
-- ─── Helper functions (meeting tables) ───────────────────────────────────────
...
-- ✅ END recovery_phase15a_meetings_after_partial_failure
-- NEXT: Run migrations 013–015 from manual_run_007_015.sql
