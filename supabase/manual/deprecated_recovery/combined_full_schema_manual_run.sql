-- WARNING:
-- Run this only on a fresh Supabase project.
-- Do not run this on an existing populated database.
-- Do not run seed.sql.
-- If any error occurs, stop and do not continue.
-- This file is for manual SQL Editor bootstrap only.

-- =====================================================
-- 001 schema
-- Source: 202607010001_schema.sql
-- =====================================================
...
-- ✅ END OF 001 schema
-- NEXT: 002 rls_policies

-- =====================================================
-- 002 rls_policies
-- Source: 202607010002_rls_policies.sql
-- =====================================================
...
-- ✅ END OF 002 rls_policies
-- NEXT: 003 phase5_clerk_jwt

-- =====================================================
-- 003 phase5_clerk_jwt
-- Source: 202607010003_phase5_clerk_jwt.sql
-- =====================================================
...
-- ✅ END OF 003 phase5_clerk_jwt
-- NEXT: 004 phase6_documents_invites

-- =====================================================
-- 004 phase6_documents_invites
-- Source: 202607010004_phase6_documents_invites.sql
-- =====================================================
...
-- ✅ END OF 004 phase6_documents_invites
-- NEXT: 005 phase7_submittals

-- =====================================================
-- 005 phase7_submittals
-- Source: 202607010005_phase7_submittals.sql
-- =====================================================

-- NOTE: Not wrapped in BEGIN/COMMIT (ALTER TYPE ADD VALUE).
...
-- ✅ END OF 005 phase7_submittals
-- NEXT: 006 phase8_rfi

-- =====================================================
-- 006 phase8_rfi
-- Source: 202607010006_phase8_rfi.sql
-- =====================================================
...
-- ✅ END OF 006 phase8_rfi
-- NEXT: 007 phase10_resources

-- =====================================================
-- 007 phase10_resources
-- Source: 202607010007_phase10_resources.sql
-- =====================================================
...
-- ✅ END OF 007 phase10_resources
-- NEXT: 008 phase11_timesheets_leave

-- =====================================================
-- 008 phase11_timesheets_leave
-- Source: 202607010008_phase11_timesheets_leave.sql
-- =====================================================
...
-- ✅ END OF 008 phase11_timesheets_leave
-- NEXT: 009 phase12_financials

-- =====================================================
-- 009 phase12_financials
-- Source: 202607010009_phase12_financials.sql
-- =====================================================
...
-- ✅ END OF 009 phase12_financials
-- NEXT: 010 phase13_notifications_activity

-- =====================================================
-- 010 phase13_notifications_activity
-- Source: 202607010010_phase13_notifications_activity.sql
-- =====================================================
...
-- ✅ END OF 010 phase13_notifications_activity
-- NEXT: 011 phase14_analytics_reports

-- =====================================================
-- 011 phase14_analytics_reports
-- Source: 202607010011_phase14_analytics_reports.sql
-- =====================================================
...
-- ✅ END OF 011 phase14_analytics_reports
-- NEXT: 012 phase15a_meetings

-- =====================================================
-- 012 phase15a_meetings
-- Source: 202607010012_phase15a_meetings.sql
-- =====================================================
...
-- ✅ END OF 012 phase15a_meetings
-- NEXT: 013 phase15b_electrical

-- =====================================================
-- 013 phase15b_electrical
-- Source: 202607010013_phase15b_electrical.sql
-- =====================================================
...
-- ✅ END OF 013 phase15b_electrical
-- NEXT: 014 phase15c_ai

-- =====================================================
-- 014 phase15c_ai
-- Source: 202607010014_phase15c_ai.sql
-- =====================================================
...
-- ✅ END OF 014 phase15c_ai
-- NEXT: 015 phase15d_client_portal

-- =====================================================
-- 015 phase15d_client_portal
-- Source: 202607010015_phase15d_client_portal.sql
-- =====================================================
...
-- ✅ END OF 015 phase15d_client_portal
-- NEXT: (complete)
