-- ===========================================================================
-- ElectraFlow AI — Recovery: Phase 15B Electrical (after partial failure)
-- ===========================================================================
-- Use when manual_run_007_015.sql failed at can_view_panel() because
-- panel_schedules did not exist yet (pre-fix migration ordering bug).
--
-- Safe after: chunks 001–006 + phase15a recovery completed.
-- Does NOT drop unrelated tables. No seed data.
--
-- NEXT after this file succeeds:
--   supabase/manual/remaining_after_phase15b_recovery.sql
-- ===========================================================================
...
-- ✅ END recovery_phase15b_electrical_after_partial_failure
