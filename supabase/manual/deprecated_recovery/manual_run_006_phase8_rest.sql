...
-- >>> RUN STEP 5 of 6: 006 phase8 — remainder (DDL, RLS, indexes)
-- Source: 202607010006_phase8_rfi.sql (lines 18–end)
-- Previous: manual_run_006_phase8_enum_only.sql
-- Next: manual_run_007_015.sql
-- =====================================================
