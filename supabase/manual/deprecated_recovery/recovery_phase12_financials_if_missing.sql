-- ===========================================================================
-- ElectraFlow AI — Recovery: Phase 12 Financials (apply if missing)
-- ===========================================================================
-- Run when inspect_database_state.sql shows missing Phase 12 objects
-- (especially invoices, invoice_items, payments).
--
-- Safe to run when tables are absent OR partially present:
--   CREATE TABLE IF NOT EXISTS, CREATE INDEX IF NOT EXISTS,
--   DROP POLICY IF EXISTS + CREATE POLICY, DROP TRIGGER IF EXISTS.
-- Does NOT drop tables or data. No seed data.
--
-- Prerequisites: chunks 001–006 + Phase 5 helpers (get_my_org_id, get_my_role).
-- Requires set_updated_at() from earlier migrations.
-- ===========================================================================
...
CREATE TABLE IF NOT EXISTS project_budgets (
  ...
  approved_changes    numeric(15,2) NOT NULL DEFAULT 0,
...
-- ✅ END recovery_phase12_financials_if_missing
-- Re-run inspect_database_state.sql — 012_phase12 rows should all be true.
