...
function Workload() {
  return (
    <>
      ...
      <Card className="mb-4">
        <CardHeader>
          <CardTitle className="text-base">Required vs Available Engineers</CardTitle>
        </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            {[
              ...
              <div key={x.n} className="flex items-center justify-between p-3 rounded-md border">
          ...
          <CardContent className="space-y-2 text-sm">
            {data
              ...
              .map((d) => (
                <div
                  key={d.m}
                  className="p-3 rounded-md border bg-destructive/5 border-destructive/30 flex items-center justify-between"
                >
                  <span>
                    <b>{d.m}</b> — capacity exceeded
                  </span>
            ...
            <div className="text-xs text-muted-foreground">
              Months over 100% utilization need hiring or reallocation.
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Hiring Suggestions</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-sm">
            {[
